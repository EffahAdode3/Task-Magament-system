              ...
              <div class="formbg-outer">
                <div class="formbg">
                  <div class="formbg-inner padding-horizontal--48">
                    ...
                    <form id="stripe-login" @submit.prevent=" ResetYourPassword" :class="{ disabled: toggledisabled }">
                      ...
                      <div class="field padding-bottom--24">
                        ...
                        <input type="password" name="password" v-model="confirmPassword" @focus="clearError('confirmPassword')" required>
